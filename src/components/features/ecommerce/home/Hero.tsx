...
import { useBannerProducts } from '@/lib/hooks/useProducts';
import 'swiper/css';
...
export default function Hero() {
    const { data: bannerData, isLoading } = useBannerProducts();
    const slideContent = transformBannerData(bannerData as BannerProduct[][][] | undefined);
    ...
    if (!isLoading && slideContent.length === 0) {
        return null;
    }
    ...
    return (
        <section className="hero_section">
            <div className="container mx-auto">
                {isLoading ? (
                    <div className="slider_el_wrapper loading">
